...
namespace JurayUniversal.Website.Areas.UI.Pages.SectionPage
{
    ...
    public class CarspotSectionModel : PageModel
    {
        private readonly IWebHostEnvironment _hostingEnvironment;

        public CarspotSectionModel(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public void OnGet()
        {
            ...
            string folderPath = Path.Combine(webRootPath, "templatesample/carsport"); // Path to your image folder
