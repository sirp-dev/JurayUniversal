...
namespace JurayUniversal.Website.Areas.NIPSS.Pages.Account
{
    ...
    public class MealEvaluationModel : PageModel
    {
        private readonly JurayUniversal.Persistence.EF.SQL.DashboardDbContext _context;
        private readonly UserManager<Profile> _userManager;

        public MealEvaluationModel(JurayUniversal.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            //{
            //    var nextevaluation = list.UserNutritionEvaluation.Where(x => x.UserId == UserDatas.Id).ToList();
            ...
            return RedirectToPage("./MealEvaluation"); // Redirect back to the same page after submission
        }
