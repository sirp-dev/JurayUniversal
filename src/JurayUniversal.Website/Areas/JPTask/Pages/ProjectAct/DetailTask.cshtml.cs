...
namespace JurayUniversal.Website.Areas.JPTask.Pages.ProjectAct
{
    ...
    public class DetailTaskModel : PageModel
    {
        ...
        public DetailTaskModel(JurayUniversal.Persistence.EF.SQL.DashboardDbContext context, UserManager<Profile> userManager, IEmailSendService email, LoggerLibrary logger)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostUserReport(string message, long id)
        {
            ...
            return RedirectToPage("./DetailTask", new { id = id });
        }
