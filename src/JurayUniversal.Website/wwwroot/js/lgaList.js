  ...
  const toggleLGAList = target => {
    ...
    lgas.forEach(lga => {
      ...
      opt.appendChild(document.createTextNode(lgadata));                                  // Append LGA to it
        opt.value = lgadata;                                                                // Set the value to LGA

      // Make option asking you to select unclickable
        lgadata.includes("elect")
